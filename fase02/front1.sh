...
IP_PRIVADA_MYSQL_SERVER=172.31.51.152
IP_PUBLICA_BALANCEADOR=100.25.10.105
# IP privada del front2
IP_PRIVADA_FRONT_NFS_CLIENT=172.31.49.10
...
#Reemplaza el carácter / por el carácter _ por el conflicto de las /\
